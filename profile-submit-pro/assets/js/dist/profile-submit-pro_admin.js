...
})({"gk2UF":[function(require,module,exports) {
...
var _submissionsPage = require("./admin/submissions-page");
var _settingsPage = require("./admin/settings-page");
if (module.hot) module.hot.accept();
(0, _alpinejsDefault.default).plugin((0, _maskDefault.default));
(0, _alpinejsDefault.default).data("submissionsPageHandler", (0, _submissionsPage.submissionsPageHandler));
(0, _alpinejsDefault.default).data("settingsPageHandler", (0, _settingsPage.settingsPageHandler));
(0, _alpinejsDefault.default).start();

},{"alpinejs":"69hXP","@parcel/transformer-js/src/esmodule-helpers.js":"dIQaP","./admin/submissions-page":"7p6BA","./admin/settings-page":"7wbvo","@alpinejs/mask":"Wq5VZ"}],"69hXP":[function(require,module,exports) {
    ...
    return {
        ...
        deleteRecord (submissionId) {
            (0, _sweetalert2Default.default).fire({
                ...
                if (result.isConfirmed) (0, _sweetalert2Default.default).fire({
                    title: "Delete User?",
                    ...
                    if (userResult.isConfirmed) deleteUser = true;
                    try {
        ...
        async deleteSubmission (submissionId, deleteUser) {
            try {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"dIQaP","sweetalert2":"1HyFr"}],"1HyFr":[function(require,module,exports) {
/*!
...
},{}],"7wbvo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "settingsPageHandler", ()=>settingsPageHandler);
var _generalSettings = require("./tabs/general-settings");
var _submissions = require("./tabs/submissions");
function settingsPageHandler() {
    return {
        generalSettingsTabHandler: (0, _generalSettings.generalSettingsTabHandler),
        submissionsTabHandler: (0, _submissions.submissionsTabHandler)
    };
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"dIQaP","./tabs/general-settings":"iprby","./tabs/submissions":"7teli"}],"iprby":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "generalSettingsTabHandler", ()=>generalSettingsTabHandler);
function generalSettingsTabHandler() {
    return {
        formData: {
        ...
        async getGeneralSettings () {
            ...
            const generalSettingsJson = await generalSettingsResponse.json();
            ...
            this.originalGeneralSettings = JSON.parse(JSON.stringify(preparedFormData));
        },
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"dIQaP"}],"7teli":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "submissionsTabHandler", ()=>submissionsTabHandler);
var _sweetalert2 = require("sweetalert2");
var _sweetalert2Default = parcelHelpers.interopDefault(_sweetalert2);
var _utils = require("../../utils");
function submissionsTabHandler() {
    return {
        formData: {
        ...
        async getSubmissionsSettings () {
            ...
            const submissionsSettingsJson = await submissionsSettingsResponse.json();
            ...
            this.formData = preparedFormData;
            this.originalSubmissionsSettings = JSON.parse(JSON.stringify(preparedFormData));
        },
        validateIfFormIsChanged () {
            return JSON.stringify(this.formData) !== JSON.stringify(this.originalSubmissionsSettings);
        },
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"dIQaP","sweetalert2":"1HyFr","../../utils":"hFIk5"}],"hFIk5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./dayjs":"77bWH","@parcel/transformer-js/src/esmodule-helpers.js":"dIQaP","f43da30d0f119095":"c7Zni","intl-tel-input":"lXOeg"}],"77bWH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _dayjs = require("dayjs");
var _dayjsDefault = parcelHelpers.interopDefault(_dayjs);
...
},{}],"c7Zni":[function(require,module,exports) {
module.exports = require("1337f619f463c90f")(require("6a168331e9479635").getBundleURL("buBGy") + "utils.a307ef1f.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root("6T2X9"));

},{"1337f619f463c90f":"efcI5","6a168331e9479635":"3w9oH"}],"efcI5":[function(require,module,exports) {
"use strict";
...
},{}],"Wq5VZ":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"dIQaP"}]},["gk2UF","f7HqZ"], "f7HqZ", "parcelRequire4480")
