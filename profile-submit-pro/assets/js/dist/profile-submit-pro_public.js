...
module.bundle.HMR_BUNDLE_ID = "8406c229ef8962ed";
"use strict";
...
},{}],"fyuRC":[function(require,module,exports) {
...
function profileFormHandler() {
    return {
        ...
        loading: false,
        async init () {
            await (0, _utils.loadIntlTelInput)((country_code)=>{
        ...
        async fetchCountries () {
            this.countries = await (0, _utils.getCountries)();
        },
        ...
        validateAddress () {
            ...
            this.errors.address.street_number = this.formData.address.street_number ? "" : this.translations.errors.address.street_number;
            ...
            this.errors.address.postal_code = this.formData.address.postal_code ? "" : this.translations.errors.address.postal_code;
...
},{"./dayjs":"77bWH","@parcel/transformer-js/src/esmodule-helpers.js":"dIQaP","f43da30d0f119095":"29ysN","intl-tel-input":"lXOeg"}],"77bWH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _dayjs = require("dayjs");
var _dayjsDefault = parcelHelpers.interopDefault(_dayjs);
...
},{"51d441ccc900ae89":"efcI5","3c69496d0ba78563":"3w9oH"}],"efcI5":[function(require,module,exports) {
"use strict";
