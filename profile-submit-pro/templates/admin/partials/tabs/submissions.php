	...
	<form method="post" @submit.prevent="saveSubmissionsSettings">
		<div class="bg-white shadow-md rounded-md p-4 mb-4">
			...
			<div class="my-4 w-full md:w-1/3">
				...
				<input type="text" x-model="formData.date_format" id="date_format" name="date_format" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm/6 w-full" :placeholder="translations.placeholders.date_format" />
			</div>
